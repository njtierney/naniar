...
#'
#' @note can we generalise label_na to work for any number of variables?
#'
#' @examples
#' \dontrun{
#' label_na_1d(airquality$Ozone)
#' }
label_na_1d <- function(x1){
...
#' @examples
#' \dontrun{
#' label_na_2d(airquality$Ozone, airquality$Solar.R)
#' }
label_na_2d <- function(x1, x2){
