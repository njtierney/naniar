...
You can also plot the number of missings in a variable grouped by another variable using the `group` argument.
...
You can also explore the misisngness in cases over some variable using `group = Month`
...
You can also explore `miss_var_span` by group with the `group` argument.
