...
There are more visualisations available in `naniar` (each starting with `gg_miss_`) - you can see these in the ["Gallery of Missing Data Visualisations" vignette.](https://cran.r-project.org/web/packages/naniar/vignettes/naniar-visualisation.html).
...
Using the easy-to-use [`simputation`](https://cran.r-project.org/web/packages/simputation/index.html) package, we impute values for Ozone, then visualise the data:
