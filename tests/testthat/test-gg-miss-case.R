...
test_that("gg_miss_case_works", {
  skip_on_cran()
  skip_on_ci()
  vdiffr::expect_doppelganger("gg_miss_case", gg_miss_case_plot)
})
...
test_that("gg_miss_case_group_works", {
  skip_on_cran()
  skip_on_ci()
  vdiffr::expect_doppelganger("gg_miss_case_group", gg_miss_case_plot_group)
})
...
test_that("gg_miss_case_sort_works", {
  skip_on_cran()
  skip_on_ci()
  vdiffr::expect_doppelganger("gg_miss_case_sort", gg_miss_case_plot_sort)
})

gg_miss_case_plot_order_group_sort <- gg_miss_case(
  dat,
  facet = month,
  order_cases = TRUE
)
...
gg_miss_case_plot_group_show_pct <- gg_miss_case(
  dat,
  facet = month,
  show_pct = TRUE
)
...
test_that("gg_miss_case_group_works_show_pct", {
  ...
  skip_on_ci()
  vdiffr::expect_doppelganger(
    "gg_miss_case_group_show_pct",
    gg_miss_case_plot_group_show_pct
  )
})

gg_miss_case_plot_sort_show_pct <- gg_miss_case(
  dat,
  order_cases = TRUE,
  show_pct = TRUE
)
...
test_that("gg_miss_case_sort_works_show_pct", {
  ...
  skip_on_ci()
  vdiffr::expect_doppelganger(
    "gg_miss_case_sort_show_pct",
    gg_miss_case_plot_sort_show_pct
  )
})

gg_miss_case_plot_order_group_sort_show_pct <- gg_miss_case(
  dat,
  facet = month,
  order_cases = TRUE,
  show_pct = TRUE
...
test_that("gg_miss_case_group_and_sort_works_show_pct", {
  ...
  skip_on_ci()
  vdiffr::expect_doppelganger(
    "gg_miss_case_group_and_sort_show_pct",
