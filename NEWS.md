...
- Deprecated `replace_to_na`, with `replace_with_na`, as it is a more natural phrase ("replace water to wine" vs "replace water with wine")
- New "scoped variants" of `replace_with_na` thanks to the work of Colin Fay:
