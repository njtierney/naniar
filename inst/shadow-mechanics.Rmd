---
title: "Mechanics of shadow_shift in narnia"
...
This vignette describes the mechanics behind `shadow_shift`, and steps you through how the functions work. It is not intended to be a user guide on how to use narnia - for that please read the [README on GitHub](https://github.com/njtierney/narnia). Instead, it serves to document my initial process for creating the functions
