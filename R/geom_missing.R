...
#  geom_missing()
#
# Very first attempt at creating a geom that is compatible with ggplot2. Data plotting works. Still todo:
...
GeomMissing <- ggproto("GeomMissing", Geom,
                       required_aes = c("x", "y"),
...
geom_missing <- function(mapping = NULL, data = NULL, stat = "identity",
