...
To read more about the functions available in `visdat` see the vignette ["Using visdat"](https://cran.r-project.org/web/packages/visdat/vignettes/using_visdat.html)
