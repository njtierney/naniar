---
title: "Getting Started with Narnia"
...
Another approach to visualising the missings in a dataset is to use the `gg_missing_var` plot:
...
There are also summary functions for time series data:

- `miss_ts_run`, and 
- `miss_ts_summary`

In time series data it can be useful to provide summaries for the number of missings or complete values in a single run.

`miss_ts_run` provides a data.frame of the run length of missings and complete values.
...
- Develop methods for handling and visualising imputations, and multiple imputation.

# Thank you

A huge thanks of course to Di Cook and Miles McBain for their assistance on this project, and its development. In particular, I thank Di for providing the large conceptual ideas of how to display missings, and the use of the shadow matrix. I also thank Miles for his instrumental work in getting 
...
- https://www.github.com/njtierney/visdat
- https://www.github.com/njtierney/narnia
