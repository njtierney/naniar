...
Julia Silge provided a really interesting blog post that looked at all of the CRAN package description files and did some really nifty text analysis. I won't (yet!) be using tidytext, but she used the function `tools::CRAN_package_db()` to get a list of the R packages available on CRAN.
