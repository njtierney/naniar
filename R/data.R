...
#' variables.
#' \describe{\item{\code{year}}{A factor with levels
...
#' @keywords datasets
#' @seealso library(MissingDataGUI)
NULL
...
#' graduate).}
#'
#' \item{\code{EMPLOY}}{A factor showing the employment
...
#'
#' \item{\code{INCOME2}}{The annual household income from all sources with levels \code{<10k} \code{10-15k} \code{15-20k} \code{20-25k} \code{25-35k} \code{35-50k} \code{50-75k} \code{>75k} \code{Dontknow} \code{Refused}.} \item{\code{WEIGHT2}}{The weight without shoes in pounds.}
#'
#' \item{\code{HEIGHT3}}{The weight without shoes in inches.}
#'
#' \item{\code{PREGNANT}}{Whether pregnant now with two
...
#'
#' \item{\code{POTATOES}}{ The number of
