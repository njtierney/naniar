...
Missing values are ubiquitous in data and need to be carefully explored and handled in the initial stages of analysis. In this vignette we describe the tools in the package `naniar` for exploring missing data structures with minimal deviation from the common workflows of ggplot and tidy data ([Wickham, 2014](https://www.jstatsoft.org/article/view/v059i10), [Wickham, 2009](https://www.springer.com/gp/book/9780387981413)).
